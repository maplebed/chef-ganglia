...
#####  I can't get this stuff's syntax right.
#####  The goal is to test what happens when the default cluster doesn't exist.
#####  At the moment, it creates a broken gmond.conf, but I want to put an assert in the recipe on empty ports
